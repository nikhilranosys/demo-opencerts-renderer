...
import { SMUOpencertsTemplateCertificate1 } from "../SMUSamples";
...
export const CertificateTemplate: FunctionComponent<TemplateProps<SMUOpencertsTemplateCertificate1>> = ({
  document
}) => {
